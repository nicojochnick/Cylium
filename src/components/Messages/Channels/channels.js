...
function Channels(props) {
    ...
    return (
            <Box border = {1} borderColor = {'lightgrey'} display= 'flex' flexDirection={'row'} justifyContent={'center'} alignItems={'center'} style = {{height: '12vh', backgroundColor:props.user.theme === 'light' ? 'white' : '#363638',}}>
                    <Autocomplete
                        value={value}
