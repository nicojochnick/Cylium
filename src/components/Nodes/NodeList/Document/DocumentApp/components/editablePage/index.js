...
const EditablePage = ({  data, fetchedBlocks, err }) => {
  console.log('here', data)
  const [blocks, setBlocks] = useState(data.content);
  const [currentBlockId, setCurrentBlockId] = useState('2sis');
  const [id, setID] = React.useState('djodoijjdj');
